...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        ...
        self.text_publisher_ = self.create_publisher(Int32, 'text', 10)
        self.float_publisher_ = self.create_publisher(Float32, 'float', 10)
        self.bool_publisher_ = self.create_publisher(Bool, 'bool', 10)
